...
<div class="post-image narrow">
  <img src="/assets/images/v2.6.0-local-mode-auth.png" alt="The sign-in screen with the option to use PeerLLM locally with no account" style="max-width: 400px;">
</div>
...
<div class="post-image">
  <img src="/assets/images/v2.6.0-local-rest-server.png" alt="The PeerLLM Server page showing the local REST API Base URL, Port, a Generate button for the API key, and server status">
</div>
